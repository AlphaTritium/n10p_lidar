...
public:
    LidarPointcloudProcessor() : Node("lidar_pointcloud_processor"), next_pole_id_(0)
    {
        ...
        this->declare_parameter<double>("pole_radius_tolerance", 0.005);
        ...
        this->declare_parameter<std::vector<double>>("expected_inter_pole_distances", std::vector<double>{0.18});
